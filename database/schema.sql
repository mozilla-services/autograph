...
('appkey2', 'contentsignature', null, jsonb_build_object(
    'privatekey', '-----BEGIN EC PARAMETERS-----
BggqhkjOPQMBBw==
-----END EC PARAMETERS-----
-----BEGIN EC PRIVATE KEY-----
...
-----END EC PRIVATE KEY-----
'), 'a p256 key'),
('normandy', 'contentsignaturepki', null, jsonb_build_object(
  'validity', '708h',
  'clockskewtolerance', '1h',
  'chainlocation', '/tmp/autograph/chains/normandydev/',
  'x5u', 'file:///tmp/autograph/chains/normandydev/',
  'issuerprivkey', '-----BEGIN EC PRIVATE KEY-----
MIGkAgEBBDBEk1fq5FMwBSLKDldmW+QRo15eebdJK1DdrUlp2SmwVf85TffXlFsa
accDMiiow/WgBwYFK4EEACKhZANiAARP5dbB0qgDev4IRzVkuHDYf2TDc8YkpNFW
nQ/KonN1EWrMIWNAeuOOJgjswwq0+M2J0/TNcnYlts5tVZh6MFYKwYHG/NlkTZZ5
5wb3GKy8JkoFH/X74Tm3o06hf0BuCfY=
-----END EC PRIVATE KEY-----
', 'issuercert' , '-----BEGIN CERTIFICATE-----

...
b3ppbGxhLm9yZzAKBggqhkjOPQQDAwNnADBkAjBPi4uhzbCzoFxYD2LZY+hUQ1kX
eHE9YmF0NOBbosIY041UrbLQLpQRXi4LFku9008CMGoSf/UGB6qV9KzsCY3s51Lp
Rw/oK58D2n63FpPnOTICWvWAYsG3HPNCoURfLqlEOQ==
-----END CERTIFICATE-----
...
-----END CERTIFICATE-----
'), 'Development Normandy content signer. Will issue a certificate
valid for normandy.content-signature.mozilla.org. To use this
...
('remote-settings', 'contentsignaturepki', null, jsonb_build_object(
  'validity', '708h',
  'clockskewtolerance', '1h',
...
Note the private key of the root was not saved. Use tools/genpki to
make a new config as needed.'),
('webextensions-rsa', 'xpi', 'add-on', jsonb_build_object(
  'recommendation', jsonb_build_object('path', 'mozilla-recommendation.json'),
...
('extensions-ecdsa', 'xpi', 'extension', jsonb_build_object(
  'recommendation', jsonb_build_object('path', 'mozilla-recommendation.json'),
  'certificate', '-----BEGIN CERTIFICATE-----
...
-----END EC PRIVATE KEY-----
'), null),
('extensions-ecdsa-expired-chain', 'xpi', 'extension', jsonb_build_object(
  'recommendation', jsonb_build_object('path', 'mozilla-recommendation.json'),
  'certificate', '-----BEGIN CERTIFICATE-----
...
('testapp-android-legacy', 'apk2', null, jsonb_build_object(
  'certificate', '-----BEGIN CERTIFICATE-----
...
-----END PRIVATE KEY-----
'), null),
('legacy_apk_with_rsa', 'apk2', null, jsonb_build_object(
  'certificate', '-----BEGIN CERTIFICATE-----
MIIDyTCCArGgAwIBAgIEVxuKpDANBgkqhkiG9w0BAQsFADCBlDELMAkGA1UEBhMC
VVMxEzARBgNVBAgTCkNhbGlmb3JuaWExFjAUBgNVBAcTDU1vdW50YWluIFZpZXcx
HDAaBgNVBAoTE01vemlsbGEgQ29ycG9yYXRpb24xHDAaBgNVBAsTE1JlbGVhc2Ug
...
-----END PRIVATE KEY-----
'), null),
('testapp-android', 'apk2', null, jsonb_build_object(
  'certificate', '-----BEGIN CERTIFICATE-----
MIIDyTCCArGgAwIBAgIEVxuKpDANBgkqhkiG9w0BAQsFADCBlDELMAkGA1UEBhMC
VVMxEzARBgNVBAgTCkNhbGlmb3JuaWExFjAUBgNVBAcTDU1vdW50YWluIFZpZXcx
HDAaBgNVBAoTE01vemlsbGEgQ29ycG9yYXRpb24xHDAaBgNVBAsTE1JlbGVhc2Ug
...
-----END PRIVATE KEY-----
'), null),
('testapp-android-v3', 'apk2', 'v3enabled', jsonb_build_object(
  'certificate', '-----BEGIN CERTIFICATE-----
MIIDyTCCArGgAwIBAgIEVxuKpDANBgkqhkiG9w0BAQsFADCBlDELMAkGA1UEBhMC
VVMxEzARBgNVBAgTCkNhbGlmb3JuaWExFjAUBgNVBAcTDU1vdW50YWluIFZpZXcx
HDAaBgNVBAoTE01vemlsbGEgQ29ycG9yYXRpb24xHDAaBgNVBAsTE1JlbGVhc2Ug
...
-----END PRIVATE KEY-----
'), null),
('apk_cert_with_ecdsa_sha256', 'apk2', null, jsonb_build_object(
  'certificate', '-----BEGIN CERTIFICATE-----
MIIEaDCCA+6gAwIBAgIBATAKBggqhkjOPQQDAjCBvDELMAkGA1UEBhMCVVMxCzAJ
BgNVBAgTAkNBMRYwFAYDVQQHEw1Nb3VudGFpbiBWaWV3MRwwGgYDVQQKExNBbGxp
em9tIENvcnBvcmF0aW9uMSAwHgYDVQQLExdBbGxpem9tIEFNTyBEZXZlbG9wbWVu
...
-----END EC PRIVATE KEY-----
'), null),
('apk_cert_with_ecdsa_sha256_v3', 'apk2', 'v3enabled', jsonb_build_object(
  'certificate', '-----BEGIN CERTIFICATE-----
MIIEaDCCA+6gAwIBAgIBATAKBggqhkjOPQQDAjCBvDELMAkGA1UEBhMCVVMxCzAJ
BgNVBAgTAkNBMRYwFAYDVQQHEw1Nb3VudGFpbiBWaWV3MRwwGgYDVQQKExNBbGxp
em9tIENvcnBvcmF0aW9uMSAwHgYDVQQLExdBbGxpem9tIEFNTyBEZXZlbG9wbWVu
...
-----END EC PRIVATE KEY-----
'), null),
('testmar', 'mar', null, jsonb_build_object(
  'privatekey', '-----BEGIN PRIVATE KEY-----
MIIEvAIBADANBgkqhkiG9w0BAQEFAASCBKYwggSiAgEAAoIBAQCAUrUDTS86CuqV
ctCo8jG8SSd4W/m/A4UF0J8T+la/pnJsZt2HhQ+Ma/+HmXF8QSeVax0LfrOaRmLy
OnfwOakP7QIGYtFsBQoLV5TWJzOr2ieonQS3h9xF865lNv+i9YPRGQT+ijjtKc49
...
-----END PRIVATE KEY-----
'), null),
('testmarecdsa', 'mar', null, jsonb_build_object(
  'privatekey', '-----BEGIN EC PARAMETERS-----
BgUrgQQAIg==
-----END EC PARAMETERS-----
-----BEGIN EC PRIVATE KEY-----
...
-----END EC PRIVATE KEY-----
'), null),
('randompgp', 'gpg2', 'gpg2', jsonb_build_object(
...
'), null),
('randompgp-debsign', 'gpg2', 'debsign', jsonb_build_object(
...
-----END PGP PUBLIC KEY BLOCK-----
'), null),
('randompgp-rpmsign', 'gpg2', 'rpmsign', jsonb_build_object(
...
-----END PGP PUBLIC KEY BLOCK-----
'), null),
('pgpsubkey', 'gpg2', null, jsonb_build_object(
...
-----END PGP PUBLIC KEY BLOCK-----
'), null),
('pgpsubkey-debsign', 'gpg2', 'debsign', jsonb_build_object(
...
-----END PGP PUBLIC KEY BLOCK-----
'), null),
('dummyrsapss', 'genericrsa', 'pss', jsonb_build_object(
  'hash', 'sha1',
  'saltlength', -1,
...
-----END PUBLIC KEY-----
'), null),
('webextensions-rsa-with-recommendation', 'xpi', 'add-on-with-recommendation', jsonb_build_object(
...
''system add-on'' are signed with the OU ''Mozilla Components'' and the provided ID
''hotfix'' are signed with the OU ''Production'' and the ID ''firefox-hotfix@mozilla.org'''),
('dummyrsa', 'genericrsa', 'pss', jsonb_build_object(
  'hash', 'sha256',
  'saltlength', -1,
  'privatekey', '-----BEGIN RSA PRIVATE KEY-----
MIIEpAIBAAKCAQEAtEM/Vdfd4Vl9wmeVdCYuWYnQl0Zc9RW5hLE4hFA+c277qanE
...
-----END PUBLIC KEY-----
'), null),
('testauthenticode', 'genericrsa', 'pkcs15', jsonb_build_object(
  'hash', 'sha1',
  'privatekey', '-----BEGIN RSA PRIVATE KEY-----
MIIEpAIBAAKCAQEAtEM/Vdfd4Vl9wmeVdCYuWYnQl0Zc9RW5hLE4hFA+c277qanE
8XCK+ap/c5so87XngLLfacB3zZhGxIOut/4SlEBOAUmVNCfnTO+YkRk3A8OyJ4XN
...
('normandev', '3dhoaupudifjjvm7xznd9bn73159xn3xwr77b61kzdjwzzsjts'),
('kintodev', '3isey64n25fim18chqgewirm6z2gwva1mas0eu71e9jtisdwv6bd');

INSERT INTO auth_signers(auth, signer)
values('alice', 'appkey1'),
('alice', 'appkey2'),
('alice', 'normandy'),
('alice', 'remote-settings'),
('alice', 'webextensions-rsa'),
('alice', 'extensions-ecdsa'),
('alice', 'extensions-ecdsa-expired-chain'),
('alice', 'testapp-android-legacy'),
('alice', 'legacy_apk_with_rsa'),
('alice', 'testapp-android'),
('alice', 'testapp-android-v3'),
('alice', 'apk_cert_with_ecdsa_sha256'),
('alice', 'apk_cert_with_ecdsa_sha256_v3'),
('alice', 'testmar'),
('alice', 'testmarecdsa'),
('alice', 'randompgp'),
('alice', 'randompgp-debsign'),
('alice', 'randompgp-rpmsign'),
('alice', 'pgpsubkey'),
('alice', 'pgpsubkey-debsign'),
('alice', 'dummyrsapss'),
('alice', 'dummyrsa'),
('alice', 'testauthenticode'),
('alice', 'webextensions-rsa-with-recommendation'),
('bob', 'appkey2'),
('normandev', 'normandy'),
('kintodev', 'remote-settings');
