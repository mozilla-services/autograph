...
func TestRepack(t *testing.T) {
	...
	for _, f := range r.File {
		...
		switch f.Name {
		case "test.txt", "bootstrap.js", "install.rdf", "manifest.json":
			fileCount++
	...
	if fileCount != 4 {
		t.Fatalf("found %d data files in zip archive, expected 4", fileCount)
	}
	if !hasManifest {
...
// a basic bootstrap xpi with a manifest set to "test@example.net"
// .
// ├── bootstrap.js
// ├── install.rdf
// ├── manifest.json
// └── test.txt
var unsignedBootstrap = []byte("\x50\x4B\x03\x04\x14\x00\x00\x00\x08\x00\x62\x81\x82\x46\x7F\x0B" +
	...
	"\xA2\x1D\x55\x73\xA2\x1D\x55\x75\x78\x0B\x00\x01\x04\xE8\x03\x00" +
	"\x00\x04\xE8\x03\x00\x00\xB5\x93\x4F\x4B\xC3\x40\x10\xC5\xEF\xF9" +
	...
	"\xE0\x0B\x50\x4B\x03\x04\x14\x00\x00\x00\x08\x00\x5D\x81\x82\x46" +
	...
	"\x52\xA2\x1D\x55\x73\xA2\x1D\x55\x75\x78\x0B\x00\x01\x04\xE8\x03" +
	"\x00\x00\x04\xE8\x03\x00\x00\x85\x92\xCB\x6E\xC2\x30\x10\x45\xF7" +
	...
	"\x2F\x99\x07\xBF\x50\x4B\x03\x04\x14\x00\x00\x00\x08\x00\xBC\x3C" +
	"\x89\x4E\xEA\x3C\x31\x39\x41\x00\x00\x00\x42\x00\x00\x00\x0D\x00" +
	"\x1C\x00\x6D\x61\x6E\x69\x66\x65\x73\x74\x2E\x6A\x73\x6F\x6E\x55" +
	"\x54\x09\x00\x03\x13\x84\xAC\x5C\x13\x84\xAC\x5C\x75\x78\x0B\x00" +
	"\x01\x04\xE8\x03\x00\x00\x04\xE8\x03\x00\x00\xAB\x56\x4A\x2A\xCA" +
	"\x2F\x2F\x4E\x2D\x8A\x2F\x2E\x48\x4D\xCE\x4C\xCB\x4C\x8E\x2F\x4E" +
	"\x2D\x29\xC9\xCC\x4B\x2F\x56\xB2\xAA\x56\x4A\x4F\x4D\xCE\xCE\x07" +
	"\x31\x32\x53\x94\xAC\x94\x4A\x52\x8B\x4B\x1C\x52\x2B\x12\x73\x0B" +
	"\x72\x52\xF5\xF2\x52\x4B\x94\x6A\x6B\x6B\xB9\x00\x50\x4B\x03\x04" +
	"\x0A\x00\x00\x00\x00\x00\x86\x81\x82\x46\x7D\xB5\xAF\x6B\x37\x00" +
	"\x00\x00\x37\x00\x00\x00\x08\x00\x1C\x00\x74\x65\x73\x74\x2E\x74" +
	"\x78\x74\x55\x54\x09\x00\x03\x9B\xA2\x1D\x55\x9B\xA2\x1D\x55\x75" +
	"\x78\x0B\x00\x01\x04\xE8\x03\x00\x00\x04\xE8\x03\x00\x00\x54\x68" +
	"\x69\x73\x20\x74\x65\x73\x74\x20\x66\x69\x6C\x65\x20\x63\x61\x6E" +
	"\x20\x62\x65\x20\x61\x6C\x74\x65\x72\x65\x64\x20\x74\x6F\x20\x62" +
	"\x72\x65\x61\x6B\x20\x73\x69\x67\x6E\x69\x6E\x67\x20\x63\x68\x65" +
	"\x63\x6B\x73\x2E\x0A\x50\x4B\x01\x02\x1E\x03\x14\x00\x00\x00\x08" +
	"\x00\x62\x81\x82\x46\x7F\x0B\x45\xED\x2C\x01\x00\x00\xAB\x04\x00" +
	"\x00\x0C\x00\x18\x00\x00\x00\x00\x00\x01\x00\x00\x00\xA4\x81\x00" +
	"\x00\x00\x00\x62\x6F\x6F\x74\x73\x74\x72\x61\x70\x2E\x6A\x73\x55" +
	"\x54\x05\x00\x03\x57\xA2\x1D\x55\x75\x78\x0B\x00\x01\x04\xE8\x03" +
	"\x00\x00\x04\xE8\x03\x00\x00\x50\x4B\x01\x02\x1E\x03\x14\x00\x00" +
	"\x00\x08\x00\x5D\x81\x82\x46\xF2\xFB\xF8\x2C\x4D\x01\x00\x00\xB0" +
	"\x02\x00\x00\x0B\x00\x18\x00\x00\x00\x00\x00\x01\x00\x00\x00\xA4" +
	"\x81\x72\x01\x00\x00\x69\x6E\x73\x74\x61\x6C\x6C\x2E\x72\x64\x66" +
	"\x55\x54\x05\x00\x03\x52\xA2\x1D\x55\x75\x78\x0B\x00\x01\x04\xE8" +
	"\x03\x00\x00\x04\xE8\x03\x00\x00\x50\x4B\x01\x02\x1E\x03\x14\x00" +
	"\x00\x00\x08\x00\xBC\x3C\x89\x4E\xEA\x3C\x31\x39\x41\x00\x00\x00" +
	"\x42\x00\x00\x00\x0D\x00\x18\x00\x00\x00\x00\x00\x01\x00\x00\x00" +
	"\xB6\x81\x04\x03\x00\x00\x6D\x61\x6E\x69\x66\x65\x73\x74\x2E\x6A" +
	"\x73\x6F\x6E\x55\x54\x05\x00\x03\x13\x84\xAC\x5C\x75\x78\x0B\x00" +
	"\x01\x04\xE8\x03\x00\x00\x04\xE8\x03\x00\x00\x50\x4B\x01\x02\x1E" +
	"\x03\x0A\x00\x00\x00\x00\x00\x86\x81\x82\x46\x7D\xB5\xAF\x6B\x37" +
	"\x00\x00\x00\x37\x00\x00\x00\x08\x00\x18\x00\x00\x00\x00\x00\x01" +
	"\x00\x00\x00\xA4\x81\x8C\x03\x00\x00\x74\x65\x73\x74\x2E\x74\x78" +
	"\x74\x55\x54\x05\x00\x03\x9B\xA2\x1D\x55\x75\x78\x0B\x00\x01\x04" +
	"\xE8\x03\x00\x00\x04\xE8\x03\x00\x00\x50\x4B\x05\x06\x00\x00\x00" +
	"\x00\x04\x00\x04\x00\x44\x01\x00\x00\x05\x04\x00\x00\x00\x00")
...
Name: manifest.json
Digest-Algorithms: SHA1 SHA256
SHA1-Digest: BnPb/clnOaeIMOkySnf8sNiCobs=
SHA256-Digest: y8z02jYtRo6aAhwlk4v7nQM6ORgT207aGK0X381lWy0=
...
SHA1-Digest-Manifest: 1KFumdcBkLpQd5+YrLIRV2eI+2U=
SHA256-Digest-Manifest: UZmGVrb4DxS1ZUOAdPd6tDh9QkkptFk32JdsC6T2DqM=
